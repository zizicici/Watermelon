...
struct HomeMonthSummary: Sendable {
    ...
    static func empty(month: LibraryMonthKey) -> HomeMonthSummary {
        HomeMonthSummary(
            month: month,
            assetCount: 0,
            photoCount: 0,
...
struct HomeMonthRow: Equatable, Sendable {
    let month: LibraryMonthKey
...
struct HomeMergedYearSection: Sendable {
    let year: Int
...
enum HomeSelectionState: Sendable {
    case none, partial, all
}

enum MonthIntent: Sendable {
